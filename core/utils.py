...
def order(order_id, order_date, name, surname, address1, address2, city, pincode, country, state, email_addr, phone_number, order_items, amount_total, length, breadth, height, weight, payment_method="COD", comment="Order", pickup_location="Primary"):
